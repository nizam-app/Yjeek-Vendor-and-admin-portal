  ...
  return (
    ...
    >
      ...
      <span className="flex h-[5px] shrink-0 items-end bg-[#b86a6a] px-[2px] pb-px">
        <span className="text-[4px] font-bold uppercase leading-none text-white">{monthLabel}</span>
      </span>

      <span className="flex min-h-0 flex-1 items-center justify-center bg-[#e6e6e6]">
        <span className="text-[7px] font-bold leading-none text-[#333333]">{dayLabel}</span>
      </span>
    </span>
  )
}
