...
export const adminManagementMock = {
  ...
  marketing: {
    viewTabs: ['Notifications', 'Promo codes', 'Promo categories', 'Geofence offers', 'Cashback'],
    notifications: {
      title: 'Notifications',
...
export function buildAdminVendorDetail(vendorId) {
  ...
  return {
    ...
    tabs: ['Overview', 'Branches', 'Users & staff', 'Delivery zones', 'Promotions', 'Commission & fees', 'SLA', 'Menu Settings'],
    branches,
    users,
    deliveryZones,
    promotions,
