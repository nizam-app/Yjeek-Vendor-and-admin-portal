# Admin Dashboard — Services board
...
| --- | --- |
| Method | `GET` |
| Relative path | `/admin/dashboard/boards/services` |
| Full URL | `{VITE_API_BASE_URL}/admin/dashboard/boards/services?limit=50` |
| Auth | Bearer Admin access token via shared `apiClient` |
| Registry | `endpoints.admin.dashboard.boards.services` |
...
Same IncidentBoard layout as Pickup / Dine-in:
